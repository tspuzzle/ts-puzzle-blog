...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "challenges" ALTER COLUMN "slug_lock" SET NOT NULL;
  ...
  CREATE UNIQUE INDEX "challenges_slug_lock_idx" ON "challenges" USING btree ("slug_lock");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP INDEX "challenges_slug_lock_idx";
  DROP INDEX "payload_locked_documents_rels_challenge_user_submissions_id_idx";
  ALTER TABLE "challenges" ALTER COLUMN "slug_lock" DROP NOT NULL;
