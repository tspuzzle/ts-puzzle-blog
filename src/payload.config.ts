...
import { buildConfig, PayloadRequest, getPayload as getBasePayload } from 'payload'
...
const paylodConfig = buildConfig({
  admin: {
    components: {
...
export default paylodConfig

export const getPayload = () => {
  return getBasePayload({ config: paylodConfig })
}
